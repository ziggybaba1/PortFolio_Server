              ...
              <table class="table ">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="/project/edit/{{$project->id}}" class="btn btn-sm btn-dark">Edit</a>
                        <a href="/project/delete/{{$project->id}}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
