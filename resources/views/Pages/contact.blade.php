...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">  {{ __('Contact Page')}}</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="card">
            <div class="card-body">
              <h5 class="card-title">{{ __('Contact Page Form')}}</h5>
              @if($errors->any())
              ...
              @csrf
                <div class="col-md-12">
                  <div class="form-floating">
                    ...
                    <label for="planname">Official Phone Number</label>
                  </div>
                </div>
                <div class="col-12">
                <div class="form-floating">
                  ...
                  <label for="introdescription">Office Address</label>
                  </div>
                </div>
